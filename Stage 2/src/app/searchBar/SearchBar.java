    ...
    public List<LibraryEntry> search(final Filters filters, final String type) {
        ...
        switch (type) {
            ...
            case "host":
                ...
                for (User user : Admin.getInstance().getHosts()) {
                    entries.add(new LibraryEntry(user.getUsername()) {
                    });
                }
            ...
            case "artist":
                ...
                for (User user : Admin.getInstance().getArtists()) {
                    entries.add(new LibraryEntry(user.getUsername()) {
                    });
                }
                ...
                break;
            case "album":
                entries = new ArrayList<>(Admin.getInstance().getAllAlbums());
